...
public class LoadingScreen : MonoBehaviour
{
    ...
    private void Awake()
    {
        SceneManager.setInterpolatedProgressValue += SetImageProgress;
        SceneManager.setInterpolatedProgressValue += SetTextProgress;
    }
    ...
    private void SetImageProgress(float newValue)
    {
        _image.fillAmount = newValue;
    }

    private void SetTextProgress(float newValue)
    {
