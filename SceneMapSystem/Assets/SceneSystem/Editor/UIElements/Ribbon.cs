...
namespace TNS.SceneSystem.Editor
{
    internal class Ribbon : VisualElement
    {
        ...
        {
            // Technically Ribbon is a UI control that could be more agnostic of this specific implementation for the Memory Profiler.
        ...
        {
            public const string HelpIconButtonClass = GUIUtility.HelpIconButtonClass;
            public const string MenuIconButtonClass = GUIUtility.MenuIconButtonClass;
        }
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            private UxmlColorAttributeDescription strokeColor = new UxmlColorAttributeDescription() { name = "stroke color", defaultValue = Color.white };
            private UxmlFloatAttributeDescription lineWidth = new UxmlFloatAttributeDescription() { name = "line width", defaultValue = 2 };
            ...
            public override void Init( VisualElement ve, IUxmlAttributes bag, CreationContext cc )
            {
                ...
                var color = this.strokeColor.GetValueFromBag( bag, cc );
                var width = this.lineWidth.GetValueFromBag( bag, cc );
        ...
        public Ribbon()
        {
            ...
            var themeStyle = AssetDatabase.LoadAssetAtPath( EditorGUIUtility.isProSkin ? GUIUtility.RibbonDarkUssPath : GUIUtility.RibbonLightUssPath,
            ...
            m_Chart.style.height = m_Content.style.height;
            m_Chart.style.width = m_Content.style.width;
        }
